...
const Skill = (props: Props) => {
  return (
    <div className="block lg:w-[1100px] mx-auto my-14">
      <Title className="text-center text-2xl mb-8">Skill</Title>
      <div className="flex flex-col lg:flex-row gap-8 w-full justify-between flex-wrap">
        {skills.map((skill) => (
          <div className="flex px-9 py-6 w-[48%] gap-4">
